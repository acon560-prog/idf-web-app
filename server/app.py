...
STRIPE_PRICE_CONSULTANT_MONTHLY = (os.environ.get("STRIPE_PRICE_CONSULTANT_MONTHLY") or "").strip() or None
STRIPE_PRICE_MUNICIPAL_ANNUAL = (os.environ.get("STRIPE_PRICE_MUNICIPAL_ANNUAL") or "").strip() or None
STRIPE_PRICE_LIFETIME = (os.environ.get("STRIPE_PRICE_LIFETIME") or "").strip() or None
