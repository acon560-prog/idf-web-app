...
STRIPE_PRICE_CONSULTANT_MONTHLY = (os.environ.get("STRIPE_PRICE_CONSULTANT_MONTHLY") or "").strip()
STRIPE_PRICE_MUNICIPAL_ANNUAL = (os.environ.get("STRIPE_PRICE_MUNICIPAL_ANNUAL") or "").strip()
